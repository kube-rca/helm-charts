...
![Version: 9.1.4](https://img.shields.io/badge/Version-9.1.4-informational?style=flat-square) ![AppVersion: v3.2.0](https://img.shields.io/badge/AppVersion-v3.2.0-informational?style=flat-square)
...
|------------|------|---------|
| https://dandydeveloper.github.io/charts/ | redis-ha | 4.34.11 |
...
| redis-ha.image.tag | string | `"8.2.2-alpine"` | Redis tag # Do not upgrade to >= 7.4.0, otherwise you are no longer using an open source version of Redis |
...
| redis.image.tag | string | `"8.2.2-alpine"` | Redis tag # Do not upgrade to >= 7.4.0, otherwise you are no longer using an open source version of Redis |
