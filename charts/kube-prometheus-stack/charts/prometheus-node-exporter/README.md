...
![Version: 4.49.2](https://img.shields.io/badge/Version-4.49.2-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 1.10.2](https://img.shields.io/badge/AppVersion-1.10.2-informational?style=flat-square)
...
| zanhsieh | <zanhsieh@gmail.com> | <https://github.com/zanhsieh> |
| zeritti | <rootsandtrees@posteo.de> | <https://github.com/zeritti> |
...
| kubeRBACProxy.extraVolumeMounts | list | `[]` |  |
...
| kubeRBACProxy.tls.enabled | bool | `false` |  |
| kubeRBACProxy.tls.tlsClientAuth | bool | `false` |  |
...
| tlsSecret.caItem | string | `""` |  |
| tlsSecret.certItem | string | `"tls.crt"` |  |
| tlsSecret.enabled | bool | `false` |  |
| tlsSecret.keyItem | string | `"tls.key"` |  |
| tlsSecret.secretName | string | `"prometheus-node-exporter-tls"` |  |
| tlsSecret.volumeName | string | `"prometheus-node-exporter-tls"` |  |
